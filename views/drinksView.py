        ...
        if i + 1 < len(response.json()):
            drinkRows.append( 
                ft.Row(spacing=40,alignment=ft.MainAxisAlignment.SPACE_AROUND,controls=[
                    ft.Container(height=320,width=250,border=ft.border.all(1,ft.colors.WHITE),alignment=ft.alignment.center,bgcolor=ft.colors.BLUE_200,content= # creating the drink container with drink data
